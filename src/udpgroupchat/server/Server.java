/*
 * CS283
 * Assignment 3 - UDP pub-sub server
 * Ian Mundy
 * I am extending the code provided to us in the assignment files. 
 * 
 */
...
public class Server {
	...
	protected static Map<String, Group> groupChats = 
			Collections.synchronizedMap(new HashMap<String, Group>());
